import { ArrowLeft, ArrowLeftIcon, Loader, LoaderIcon, Trash2Icon } from "lucide-react";
...
const NoteDetailPage = () => { 
  ...
  useEffect (() => {
    ...
    fetchNote();
  }, [id]); // Fetch note when component mounts or id changes
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      navigate('/'); // Redirect to notes list after deletion
    } catch (error) {
